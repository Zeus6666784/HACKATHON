...
- **Current Phase**: Phase 1/2 (Initialization & Database) - Backend Core Complete.
...
- [x] Backend Core Implementation (2026-09-05):
  - [x] Auth & RBAC implemented.
  - [x] Patient & Facility APIs implemented.
  - [x] AI Triage with deterministic fallback implemented.
  - [x] Deterministic Facility Ranking with distance & disqualification implemented.
  - [x] Referral State Machine & Event logging implemented.
  - [x] Security (Helmet, CORS, Rate Limit) & IDOR protection implemented.
  - [x] Dashboard stats & overdue logic implemented.
